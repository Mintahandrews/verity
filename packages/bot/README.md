...
`@verity/bot` brings instant media verification directly to chat apps (Telegram & Discord) where misinformation spreads fastest. Users forward viral images or videos to [`@CheckVerityBot`](https://t.me/CheckVerityBot) or use `!verity` in Discord to receive an instant evidence-backed verdict.
...
# Start Discord Bot
npm run start:discord -w @verity/bot
```
