...
`@verity/signer` solves the "prove it's real" challenge. Before publishing original photographs, investigative video, or creative media, creators use this CLI tool to inject a tamper-evident, cryptographically signed C2PA manifest containing author attribution and cryptographic hashes.
...
npm run sign -w @verity/signer -- --input sample.jpg
```
